      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            settings_ = input.readMessage(com.google.cloud.contactcenterinsights.v1.Settings.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.contactcenterinsights.v1.UpdateSettingsRequest) e.getUnfinishedMessage();
    ...
    public Builder mergeSettings(com.google.cloud.contactcenterinsights.v1.Settings value) {
      if (settingsBuilder_ == null) {
        if (settings_ != null) {
          settings_ =
            com.google.cloud.contactcenterinsights.v1.Settings.newBuilder(settings_).mergeFrom(value).buildPartial();
        } else {
          settings_ = value;
        }
        onChanged();
