      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            analysis_ = input.readMessage(com.google.cloud.contactcenterinsights.v1.Analysis.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.contactcenterinsights.v1.CreateAnalysisRequest) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeAnalysis(com.google.cloud.contactcenterinsights.v1.Analysis value) {
      if (analysisBuilder_ == null) {
        if (analysis_ != null) {
          analysis_ =
            com.google.cloud.contactcenterinsights.v1.Analysis.newBuilder(analysis_).mergeFrom(value).buildPartial();
        } else {
          analysis_ = value;
        }
        onChanged();
